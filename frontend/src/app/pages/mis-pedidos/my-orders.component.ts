        ...
        <div class="order-card shadow-sm fade-in" *ngFor="let order of orders()">
          ...
          <div class="order-details">
            ...
            <div class="meta">
              ...
              <p><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> Entrega: {{ order.delivery.date }} ({{ order.delivery.timeSlot }})</p>
